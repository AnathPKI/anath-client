        ...
        ctrl.revokeCert = function (link, ev) {
            if (link.rel === "revoke") {
                var confirm = $mdDialog.confirm()
                    ...
                    .textContent('If you revoke this certificate it is disabled and can not be used any longer!')
            ...
            CertificatesService.singleCertificate(link, function (response) {
                if (localStorage[response.use] === undefined) {
                    ...
                    var confirm = $mdDialog.prompt()
                        ...
                        .ariaLabel('Export Password')
                        .placeholder('Hint: The characters are not hidden!')
                        .initialValue('')
                        .targetEvent(event)
                        .required(true)
                        .ok('Okay!')
